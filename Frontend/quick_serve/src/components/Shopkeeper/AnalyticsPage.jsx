      ...
      <div className="min-h-screen gradient-bg flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <div className="relative w-32 h-32 mx-auto mb-6">
            ...
            />
            <motion.div
              className="absolute inset-3 rounded-full border-3 border-transparent border-r-green-500"
              animate={{ rotate: -360 }}
              transition={{ duration: 1.8, repeat: Infinity, ease: "linear" }}
            />
            <motion.div
              className="absolute inset-6 rounded-full border-2 border-transparent border-b-orange-500"
              animate={{ rotate: 360 }}
          ...
          >
            ...
            <p className="text-slate-400">Crunching your business data...</p>
          </motion.div>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {[0, 1, 2, 3, 4].map((i) => (
              <motion.div
                key={i}
                className="w-3 h-12 bg-gradient-to-t from-blue-500 to-green-500 rounded-full"
                animate={{ 
                  scaleY: [0.3, 1, 0.3],
                  opacity: [0.3, 1, 0.3]
                }}
