      ...
      <div className="min-h-screen gradient-bg flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <div className="relative w-28 h-28 mx-auto mb-6">
            ...
            />
            <motion.div
              className="absolute inset-2 rounded-full border-3 border-transparent border-b-orange-500"
              animate={{ rotate: -360 }}
          ...
          >
            ...
            <p className="text-slate-400">Fetching your order history...</p>
          </motion.div>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {[0, 1, 2, 3, 4].map((i) => (
              <motion.div
                key={i}
                className="w-2 h-8 bg-gradient-to-t from-green-500 to-orange-500 rounded-full"
                animate={{ 
                  scaleY: [0.3, 1, 0.3],
                  opacity: [0.3, 1, 0.3]
                }}
